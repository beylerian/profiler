 ...
 */
public class AgeProfilerME implements AgeProfiler {

  private ProfilerModel model;
  private ProfilerContextGenerator mContextGenerator;

  public AgeProfilerME(ProfilerModel model) {
    this.model = model;
  }

  public String binaryAge(ProfilerSample sample) {
    return null;
  }

  public String binaryAge(ArrayList<ProfilerSample> samples) {
    return null;
  }

  public String quinaryAge(ProfilerSample sample) {
    return null;
  }

  public String quinaryAge(ArrayList<ProfilerSample> samples) {
    return null;
